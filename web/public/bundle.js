...
},{"../operators/onErrorResumeNext":108,"../util/argsOrArgArray":201,"./empty":25}],39:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../util/lift":218,"../util/noop":220,"./OperatorSubscriber":47}],51:[function(require,module,exports){
"use strict";
var __values = (this && this.__values) || function(o) {
    var s = typeof Symbol === "function" && Symbol.iterator, m = s && o[s], i = 0;
    if (m) return m.call(o);
...
},{"../observable/concat":21,"./ignoreElements":90,"./mapTo":95,"./mergeMap":101,"./take":140}],72:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../util/lift":218,"../util/noop":220,"./OperatorSubscriber":47}],74:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../observable/from":27,"../util/args":199,"../util/argsOrArgArray":201,"../util/lift":218,"./mergeAll":99}],99:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../observable/innerFrom":33,"../util/argsOrArgArray":201,"../util/lift":218,"../util/noop":220,"./OperatorSubscriber":47}],109:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../Subject":10,"../util/lift":218,"./OperatorSubscriber":47}],120:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../Subject":10,"../util/lift":218,"./OperatorSubscriber":47}],122:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../util/lift":218,"../util/noop":220,"./OperatorSubscriber":47}],123:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../util/lift":218,"./OperatorSubscriber":47}],127:[function(require,module,exports){
"use strict";
var __read = (this && this.__read) || function (o, n) {
    var m = typeof Symbol === "function" && o[Symbol.iterator];
    if (!m) return o;
...
},{"../Subject":10,"../util/lift":218,"../util/noop":220,"./OperatorSubscriber":47}],154:[function(require,module,exports){
"use strict";
var __values = (this && this.__values) || function(o) {
    var s = typeof Symbol === "function" && Symbol.iterator, m = s && o[s], i = 0;
    if (m) return m.call(o);
...
(0, rxjs_1.fromEvent)(window, "load")
    .pipe((0, rxjs_1.switchMap)((_) => fetch$("")), (0, rxjs_1.tap)((data) => setResults(data.length)), (0, rxjs_1.take)(1))
    .subscribe(populatePageContent);
const windowUnload$ = (0, rxjs_1.fromEvent)(window, "beforeunload").pipe((0, rxjs_1.take)(1));
function fetch$(text) {
...
(0, rxjs_1.fromEvent)(element, "input")
    .pipe((0, rxjs_1.map)((event) => event.target.value), (0, rxjs_1.map)((text) => text.trim()), 
// filter((text: string) => !!text),
(0, rxjs_1.debounceTime)(1000), (0, rxjs_1.distinctUntilChanged)(), (0, rxjs_1.tap)(() => (content.innerHTML = "")), (0, rxjs_1.exhaustMap)((data) => fetch$(data)), (0, rxjs_1.tap)((data) => setResults(data.length)), (0, rxjs_1.catchError)((e) => {
    console.error(e);
    return (0, rxjs_1.throwError)(() => e);
}), (0, rxjs_1.retry)(2), (0, rxjs_1.takeUntil)(windowUnload$))
    .subscribe({
...
function populatePageContent(data) {
    if (data && data.length) {
        ...
        <img src="${(_a = item.image) !== null && _a !== void 0 ? _a : defaultImg}" class="product-image" alt="...">
        </div>

        <div class="product-card-body">
          <h5 class="card-title">${item.name}</h5>
          <p class="card-text">${(_b = item.description) !== null && _b !== void 0 ? _b : ""}</p>
